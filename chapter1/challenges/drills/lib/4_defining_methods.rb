...
# returns the total
def add_number_strings(stringOne, stringTwo)
  return stringOne.to_i + stringTwo.to_i
end
...
# multiplies one by the other
# returns the result
def multiply_number_strings(stringOne, stringTwo)
  return stringOne.to_i * stringTwo.to_i
end
# both_odd?
# takes two numbers as args
...
def both_odd? (numberOne, numberTwo)
  return (numberOne.odd? && numberTwo.odd?)
end
# both_even?
# takes two numbers as args
# returns true if both are even
# otherwise, returns false
def both_even? (numberOne, numberTwo)
  return (numberOne.even? && numberTwo.even?)
end
# one_odd?
# takes two numbers as args
# returns true if at least one of them is odd
# otherwise, returns false
def one_odd?(numberOne, numberTwo)
  return (numberOne.odd? || numberTwo.odd?)
end
...
# otherwise returns false
def one_even?(numberOne, numberTwo)
  return (numberOne.even? || numberTwo.even?)
end
# rev_sym_caps
# takes one string as an arg
